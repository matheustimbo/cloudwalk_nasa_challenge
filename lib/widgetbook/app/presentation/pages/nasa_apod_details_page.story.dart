...
@widgetbook.UseCase(
  ...
  type: NasaApodDetailsPage,
)
NasaApodDetailsPage withImage(BuildContext context) {
  ...
  return NasaApodDetailsPage(
      args: NasaApodDetailsPageArgs(
...
NasaApodDetailsPage withVideo(BuildContext context) {
  final exampleApod = NasaApod.fromJson({
    "date": "2024-03-25",
    "explanation":
